        ...
        <div id="wrapper" class="BoardLayout" style="width: 933px; opacity: 1; visibility: visible;">
           ...
           // var_dump($promotion[0]);
            for ($i=0;$i<count($promotion);$i++)
            {
                echo 
                '
                <div class="pin" data-id="178173728980050005" data-closeup-url="http://media-cache-ec3.pinterest.com/550x/8b/2b/c7/8b2bc7820487be973d5bd9e1f585ba14.jpg" data-width="500" data-height="375" style="top:';echo ((int)($i/4))*350; echo 'px; left:'; echo (($i%4)*250); echo 'px;" data-col="2">
                    ...
                    <p class="description">Usual Price: S$'; echo $promotion[$i]->usualPrice;
                    echo '</p>
                    <p class="description">Offer Price: S$'; echo $promotion[$i]->discountPrice;
                    echo'</p>                    
